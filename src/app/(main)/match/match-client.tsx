        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown className={`h-4 w-4 text-muted-foreground transition-transform shrink-0 ${eventsOpen ? "rotate-180" : ""}`} />
            </button>

            {eventsOpen && (
              <div className="absolute z-20 mt-1 w-full bg-background border rounded-lg shadow-lg max-h-[min(50vh,480px)] overflow-y-auto">
                {events.length === 0 ? (
